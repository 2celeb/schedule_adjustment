...
- [x] 9. フロントエンド: Availability_Board の実装
  - [x] 9.1 カレンダー形式の一覧表示コンポーネント
...
- [x] 11. Discord Bot 基盤の実装
  ...
  - [x] 11.5 Discord Bot のユニットテスト
    - Jest でコマンドハンドラー、API クライアント、メッセージ整形のテスト
    - _要件: 8.2, 8.3, 8.4_

- [x] 12. チェックポイント - Discord Bot の確認
...
- [x] 14. リマインド・通知機能の実装
  ...
  - [x] 14.3 Discord Bot 通知送信サービスの実装
...
- [x] 16. Google カレンダー連携の実装
  - [x] 16.1 FreeBusy 同期サービスの実装
  ...
  - [x] 16.8 フロントエンド: カレンダー連携設定 UI の実装
...
- [x] 17. チェックポイント - Google カレンダー連携の確認
...
- [x] 19. データ保護・退会処理の実装
  ...
  - [x] 19.3 退会メンバー匿名化・可視性制御のプロパティテスト
